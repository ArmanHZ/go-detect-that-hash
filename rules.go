...
var (
	prototypes []Prototype = []Prototype{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{8}$`),
			mode: []HashInfo{
				{"Adler-32", -1, "", false},
				{"CRC-32B", -1, "", false},
				{"FCS-32", -1, "", false},
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{6}$`),
			mode: []HashInfo{
				{"CRC-24", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$crc32\$[a-f0-9]{8}.)?[a-f0-9]{8}$`),
			mode: []HashInfo{
				{"CRC-32", -1, "crc32", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\+[a-z0-9\/.]{12}$`),
			mode: []HashInfo{
				{"Eggdrop IRC Bot", -1, "bfegg", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9\/.]{13}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{16}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-z0-9\/.]{16}$`),
			mode: []HashInfo{
				{"Cisco-PIX(MD5)", 2400, "pix-md5", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\([a-z0-9\/+]{20}\)$`),
			mode: []HashInfo{
				{"Lotus Notes/Domino 6", 8700, "dominosec", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^_[a-z0-9\/.]{19}$`),
			mode: []HashInfo{
				{"BSDi Crypt", -1, "bsdicrypt", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{24}$`),
			mode: []HashInfo{
				{"CRC-96(ZIP)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9\/.]{24}$`),
			mode: []HashInfo{
				{"Crypt16", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$md2\$)?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"MD2", -1, "md2", false},
			},
		},
		...
		{
			regexp: regexp.MustCompile(`^(\$snefru\$)?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"Snefru-128", -1, "snefru-128", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$NT\$)?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"NTLM", 1000, "nt", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^([^\\\/:*?"<>|]{1,20}:)?[a-f0-9]{32}(:[^\\\/:*?"<>|]{1,20})?$`),
			mode: []HashInfo{
				{"Domain Cached Credentials", 1100, "mscach", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^([^\\\/:*?"<>|]{1,20}:)?(\$DCC2\$10240#[^\\\/:*?"<>|]{1,20}#)?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"Domain Cached Credentials 2", 2100, "mscach2", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{SHA}[a-z0-9\/+]{27}=$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^\$1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}(:.*)?$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^0x[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"Lineage II C4", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$H\$[a-z0-9\/.]{31}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^\$P\$[a-z0-9\/.]{31}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:[a-z0-9]{2}$`),
			mode: []HashInfo{
				{"osCommerce", 21, "", false},
		...
		{
			regexp: regexp.MustCompile(`^\$apr1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}$`),
			mode: []HashInfo{
				{"MD5(APR)", 1600, "", false},
		...
		{
			regexp: regexp.MustCompile(`^{smd5}[a-z0-9$\/.]{31}$`),
			mode: []HashInfo{
				{"AIX(smd5)", 6300, "aix-smd5", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"WebEdition CMS", 3721, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:.{5}$`),
			mode: []HashInfo{
				{"IP.Board ≥ v2+", 2811, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:.{8}$`),
			mode: []HashInfo{
				{"MyBB ≥ v1.2+", 2811, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9]{34}$`),
			mode: []HashInfo{
				{"CryptoCurrency(Adress)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{40}(:.+)?$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-z0-9]{43}$`),
			mode: []HashInfo{
				{"Cisco-IOS(SHA-256)", 5700, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{SSHA}[a-z0-9\/+]{38}==$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-z0-9=]{47}$`),
			mode: []HashInfo{
				{"Fortigate(FortiOS)", 7000, "fortigate", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{48}$`),
			mode: []HashInfo{
				{"Haval-192", -1, "", false},
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{51}$`),
			mode: []HashInfo{
				{"Palshop CMS", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9]{51}$`),
			mode: []HashInfo{
				{"CryptoCurrency(PrivateKey)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{ssha1}[0-9]{2}\$[a-z0-9$\/.]{44}$`),
			mode: []HashInfo{
				{"AIX(ssha1)", 6700, "aix-ssha1", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^0x0100[a-f0-9]{48}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^(\$md5,rounds=[0-9]+\$|\$md5\$rounds=[0-9]+\$|\$md5\$)[a-z0-9\/.]{0,16}(\$|\$\$)[a-z0-9\/.]{22}$`),
			mode: []HashInfo{
				{"Sun MD5 Crypt", 3300, "sunmd5", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{56}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^(\$2[axy]|\$2)\$[0-9]{2}\$[a-z0-9\/.]{53}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{40}:[a-f0-9]{16}$`),
			mode: []HashInfo{
				{"Android PIN", 5800, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(S:)?[a-f0-9]{40}(:)?[a-f0-9]{20}$`),
			mode: []HashInfo{
				{"Oracle 11g/12c", 112, "oracle11", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$bcrypt-sha256\$(2[axy]|2)\,[0-9]+\$[a-z0-9\/.]{22}\$[a-z0-9\/.]{31}$`),
			mode: []HashInfo{
				{"bcrypt(SHA-256)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:.{3}$`),
			mode: []HashInfo{
				{"vBulletin < v3.8.5", 2611, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:.{30}$`),
			mode: []HashInfo{
				{"vBulletin ≥ v3.8.5", 2711, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$snefru\$)?[a-f0-9]{64}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:[a-z0-9]{32}$`),
			mode: []HashInfo{
				{"Joomla < v2.5.18", 11, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f-0-9]{32}:[a-f-0-9]{32}$`),
			mode: []HashInfo{
				{"SAM(LM_Hash:NT_Hash)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$chap\$0\*)?[a-f0-9]{32}[\*:][a-f0-9]{32}(:[0-9]{2})?$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^\$episerver\$\*0\*[a-z0-9\/=+]+\*[a-z0-9\/=+]{27,28}$`),
			mode: []HashInfo{
				{"EPiServer 6.x < v4", 141, "episerver", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{ssha256}[0-9]{2}\$[a-z0-9$\/.]{60}$`),
			mode: []HashInfo{
				{"AIX(ssha256)", 6400, "aix-ssha256", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{80}$`),
			mode: []HashInfo{
				{"RIPEMD-320", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$episerver\$\*1\*[a-z0-9\/=+]+\*[a-z0-9\/=+]{42,43}$`),
			mode: []HashInfo{
				{"EPiServer 6.x ≥ v4", 1441, "episerver", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^0x0100[a-f0-9]{88}$`),
			mode: []HashInfo{
				{"MSSQL(2000)", 131, "mssql", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{96}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^{SSHA512}[a-z0-9\/+]{96}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^{ssha512}[0-9]{2}\$[a-z0-9\/.]{16,48}\$[a-z0-9\/.]{86}$`),
			mode: []HashInfo{
				{"AIX(ssha512)", 6500, "aix-ssha512", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{128}(:.+)?$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{136}$`),
			mode: []HashInfo{
				{"OSX v10.7", 1722, "xsha512", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^0x0200[a-f0-9]{136}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^\$ml\$[0-9]+\$[a-f0-9]{64}\$[a-f0-9]{128}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{256}$`),
			mode: []HashInfo{
				{"Skein-1024", -1, "", false},
			},
		},
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{49}$`),
			mode: []HashInfo{
				{"Citrix Netscaler", 8100, "citrix_ns10", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$S\$[a-z0-9\/.]{52}$`),
			mode: []HashInfo{
				{"Drupal > v7.x", 7900, "drupal7", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$5\$(rounds=[0-9]+\$)?[a-z0-9\/.]{0,16}\$[a-z0-9\/.]{43}$`),
			mode: []HashInfo{
				{"SHA-256 Crypt", 7400, "sha256crypt", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^0x[a-f0-9]{4}[a-f0-9]{16}[a-f0-9]{64}$`),
			mode: []HashInfo{
				{"Sybase ASE", 8000, "sybasease", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$6\$(rounds=[0-9]+\$)?[a-z0-9\/.]{0,16}\$[a-z0-9\/.]{86}$`),
			mode: []HashInfo{
				{"SHA-512 Crypt", 1800, "sha512crypt", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$sha\$[a-z0-9]{1,16}\$([a-f0-9]{32}|[a-f0-9]{40}|[a-f0-9]{64}|[a-f0-9]{128}|[a-f0-9]{140})$`),
			mode: []HashInfo{
				{"Minecraft(AuthMe Reloaded)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^sha256\$[a-z0-9]+\$[a-f0-9]{64}$`),
			mode: []HashInfo{
				{"Django(SHA-256)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^sha384\$[a-z0-9]+\$[a-f0-9]{96}$`),
			mode: []HashInfo{
				{"Django(SHA-384)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^crypt1:[a-z0-9+=]{12}:[a-z0-9+=]{12}$`),
			mode: []HashInfo{
				{"Clavister Secure Gateway", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{112}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^([^\\\/:*?"<>|]{1,20}\\)?[^\\\/:*?"<>|]{1,20}[:]{2,3}([^\\\/:*?"<>|]{1,20}:)?[^\\\/:*?"<>|]{1,20}:[a-f0-9]{32}:[a-f0-9]+$`),
			mode: []HashInfo{
				{"NetNTLMv2", 5600, "netntlmv2", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$(krb5pa|mskrb5)\$([0-9]{2})?\$.+\$[a-f0-9]{1,}$`),
			mode: []HashInfo{
				{"Kerberos 5 AS-REQ Pre-Auth", 7500, "krb5pa-md5", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$scram\$[0-9]+\$[a-z0-9\/.]{16}\$sha-1=[a-z0-9\/.]{27},sha-256=[a-z0-9\/.]{43},sha-512=[a-z0-9\/.]{86}$`),
			mode: []HashInfo{
				{"SCRAM Hash", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{40}:[a-f0-9]{0,32}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^(.+\$)?[a-z0-9\/.+]{30}(:.+)?$`),
			mode: []HashInfo{
				{"Juniper Netscreen/SSG(ScreenOS)", 22, "md5ns", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^0x[a-f0-9]{60}\s0x[a-f0-9]{40}$`),
			mode: []HashInfo{
				{"EPi", 123, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{40}:[^*]{1,25}$`),
			mode: []HashInfo{
				{"SMF ≥ v1.1", 121, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$wbb3\$\*1\*)?[a-f0-9]{40}[:*][a-f0-9]{40}$`),
			mode: []HashInfo{
				{"Woltlab Burning Board 3.x", 8400, "wbb3", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{130}(:[a-f0-9]{40})?$`),
			mode: []HashInfo{
				{"IPMI2 RAKP HMAC-SHA1", 7300, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{32}:[0-9]+:[a-z0-9_.+-]+@[a-z0-9-]+\.[a-z0-9-.]+$`),
			mode: []HashInfo{
				{"Lastpass", 6800, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9\/.]{16}([:$].{1,})?$`),
			mode: []HashInfo{
				{"Cisco-ASA(MD5)", 2410, "asa-md5", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$vnc\$\*[a-f0-9]{32}\*[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"VNC", -1, "vnc", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9]{32}(:([a-z0-9-]+\.)?[a-z0-9-.]+\.[a-z]{2,7}:.+:[0-9]+)?$`),
			mode: []HashInfo{
				{"DNSSEC(NSEC3)", 8300, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(user-.+:)?\$racf\$\*.+\*[a-f0-9]{16}$`),
			mode: []HashInfo{
				{"RACF", 8500, "racf", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$3\$\$[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"NTHash(FreeBSD Variant)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$sha1\$[0-9]+\$[a-z0-9\/.]{0,64}\$[a-z0-9\/.]{28}$`),
			mode: []HashInfo{
				{"SHA-1 Crypt", -1, "sha1crypt", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{70}$`),
			mode: []HashInfo{
				{"hMailServer", 1421, "hmailserver", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[:\$][AB][:\$]([a-f0-9]{1,8}[:\$])?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"MediaWiki", 3711, "mediawiki", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{140}$`),
			mode: []HashInfo{
				{"Minecraft(xAuth)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$pbkdf2(-sha1)?\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{27}$`),
			mode: []HashInfo{
				{"PBKDF2-SHA1(Generic)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$pbkdf2-sha256\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{43}$`),
			mode: []HashInfo{
				{"PBKDF2-SHA256(Generic)", -1, "pbkdf2-hmac-sha256", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$pbkdf2-sha512\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{86}$`),
			mode: []HashInfo{
				{"PBKDF2-SHA512(Generic)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$p5k2\$[0-9]+\$[a-z0-9\/+=-]+\$[a-z0-9\/+-]{27}=$`),
			mode: []HashInfo{
				{"PBKDF2(Cryptacular)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$p5k2\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{32}$`),
			mode: []HashInfo{
				{"PBKDF2(Dwayne Litzenberger)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{FSHP[0123]\|[0-9]+\|[0-9]+}[a-z0-9\/+=]+$`),
			mode: []HashInfo{
				{"Fairly Secure Hashed Password", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$PHPS\$.+\$[a-f0-9]{32}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{256}:[a-f0-9]{256}:[a-f0-9]{16}:[a-f0-9]{16}:[a-f0-9]{320}:[a-f0-9]{16}:[a-f0-9]{40}:[a-f0-9]{40}:[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"IKE-PSK MD5", 5300, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{256}:[a-f0-9]{256}:[a-f0-9]{16}:[a-f0-9]{16}:[a-f0-9]{320}:[a-f0-9]{16}:[a-f0-9]{40}:[a-f0-9]{40}:[a-f0-9]{40}$`),
			mode: []HashInfo{
				{"IKE-PSK SHA1", 5400, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-z0-9\/+]{27}=$`),
			mode: []HashInfo{
				{"PeopleSoft", 133, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^crypt\$[a-f0-9]{5}\$[a-z0-9\/.]{13}$`),
			mode: []HashInfo{
				{"Django(DES Crypt Wrapper)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$django\$\*1\*)?pbkdf2_sha256\$[0-9]+\$[a-z0-9]+\$[a-z0-9\/+=]{44}$`),
			mode: []HashInfo{
				{"Django(PBKDF2-HMAC-SHA256)", 10000, "django", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^pbkdf2_sha1\$[0-9]+\$[a-z0-9]+\$[a-z0-9\/+=]{28}$`),
			mode: []HashInfo{
				{"Django(PBKDF2-HMAC-SHA1)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^bcrypt(\$2[axy]|\$2)\$[0-9]{2}\$[a-z0-9\/.]{53}$`),
			mode: []HashInfo{
				{"Django(bcrypt)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^md5\$[a-f0-9]+\$[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"Django(MD5)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\{PKCS5S2\}[a-z0-9\/+]{64}$`),
			mode: []HashInfo{
				{"PBKDF2(Atlassian)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^md5[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"PostgreSQL MD5", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\([a-z0-9\/+]{49}\)$`),
			mode: []HashInfo{
				{"Lotus Notes/Domino 8", 9100, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^SCRYPT:[0-9]{1,}:[0-9]{1}:[0-9]{1}:[a-z0-9:\/+=]{1,}$`),
			mode: []HashInfo{
				{"scrypt", 8900, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$8\$[a-z0-9\/.]{14}\$[a-z0-9\/.]{43}$`),
			mode: []HashInfo{
				{"Cisco Type 8", 9200, "cisco8", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$9\$[a-z0-9\/.]{14}\$[a-z0-9\/.]{43}$`),
			mode: []HashInfo{
				{"Cisco Type 9", 9300, "cisco9", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$office\$\*2007\*[0-9]{2}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{40}$`),
			mode: []HashInfo{
				{"Microsoft Office 2007", 9400, "office", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$office\$\*2010\*[0-9]{6}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{64}$`),
			mode: []HashInfo{
				{"Microsoft Office 2010", 9500, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$office\$\*2013\*[0-9]{6}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{64}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^\$oldoffice\$[34]\*[a-f0-9]{32}\*[a-f0-9]{32}\*[a-f0-9]{40}$`),
			mode: []HashInfo{
		...
		{
			regexp: regexp.MustCompile(`^(\$radmin2\$)?[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"RAdmin v2.x", 9900, "radmin", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^{x-issha,\s[0-9]{4}}[a-z0-9\/+=]+$`),
			mode: []HashInfo{
				{"SAP CODVN H (PWDSALTEDHASH) iSSHA-1", 10300, "saph", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$cram_md5\$[a-z0-9\/+=-]+\$[a-z0-9\/+=-]{52}$`),
			mode: []HashInfo{
				{"CRAM-MD5", 10200, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^[a-f0-9]{16}:2:4:[a-f0-9]{32}$`),
			mode: []HashInfo{
				{"SipHash", 10100, "", false},
			},
		},
		...
		{
			regexp: regexp.MustCompile(`^(\$cisco4\$)?[a-z0-9\/.]{43}$`),
			mode: []HashInfo{
				{"Cisco Type 4", -1, "cisco4", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^bcrypt_sha256\$\$(2[axy]|2)\$[0-9]+\$[a-z0-9\/.]{53}$`),
			mode: []HashInfo{
				{"Django(bcrypt-SHA256)", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$postgres\$.[^\*]+[*:][a-f0-9]{1,32}[*:][a-f0-9]{32}$`),
			mode: []HashInfo{
				{"PostgreSQL Challenge-Response Authentication (MD5)", 11100, "postgres", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$siemens-s7\$[0-9]{1}\$[a-f0-9]{40}\$[a-f0-9]{40}$`),
			mode: []HashInfo{
				{"Siemens-S7", -1, "siemens-s7", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$pst\$)?[a-f0-9]{8}$`),
			mode: []HashInfo{
				{"Microsoft Outlook PST", -1, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^sha256[:$][0-9]+[:$][a-z0-9\/+]+[:$][a-z0-9\/+]{32,128}$`),
			mode: []HashInfo{
				{"PBKDF2-HMAC-SHA256(PHP)", 10900, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^(\$dahua\$)?[a-z0-9]{8}$`),
			mode: []HashInfo{
				{"Dahua", -1, "dahua", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$mysqlna\$[a-f0-9]{40}[:*][a-f0-9]{40}$`),
			mode: []HashInfo{
				{"MySQL Challenge-Response Authentication (SHA1)", 11200, "", false},
			},
		},
		{
			regexp: regexp.MustCompile(`^\$pdf\$[24]\*[34]\*128\*[0-9-]{1,5}\*1\*(16|32)\*[a-f0-9]{32,64}\*32\*[a-f0-9]{64}\*(8|16|32)\*[a-f0-9]{16,64}$`),
			mode: []HashInfo{
